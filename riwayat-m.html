    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <div class="container align-right-logo">
                <div id="logo">
                    <a><img src="http://bappeda.malangkota.go.id/web/wp-content/uploads/2021/04/logo-bappeda_new.png" alt="logo-bappeda" width="400" height="100"></a>
                </div>
			</div><!-- End Logo -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <br>
                                        <div class="col-md-6">
                                            <button type="button" class="btn btn-primary" href="dashboard-m.html">Tambah Aspirasi</button>
                                        </div>
                                </div><!-- End Button -->
